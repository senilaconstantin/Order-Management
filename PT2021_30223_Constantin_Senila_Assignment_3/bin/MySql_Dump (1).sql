...
CREATE TABLE `clienti` (
  ...
  `numeClienti` varchar(50) DEFAULT NULL,
...
INSERT INTO `clienti` VALUES (1,'Senila Constantin','Campeni','senila.constantin@campeni.ro');
...
CREATE TABLE `orders` (
  ...
  `numeOrders` varchar(50) DEFAULT NULL,
...
CREATE TABLE `product` (
  ...
  `numeProduct` varchar(50) DEFAULT NULL,
...
--
-- Dumping events for database 'tema3'
--
...
-- Dump completed on 2021-04-21  1:08:06
